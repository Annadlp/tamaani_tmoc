...
async def start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "🪨 *Tamaani: The Mine of Consent*\n\n"
        "Карточная игра о механизмах СПОС и имперских практиках.\n\n"
        "*Выбери кейс:*\n"
        "/case\\_anbara — 🇷🇺 Алмазы Анбара + Эвенки (Якутия)\n"
        "/case\\_norilsk — 🇷🇺 Норильск Никель + Таймыр\n"
        "/case\\_diavik — 🇨🇦 Diavik Diamond + Dene (Канада)\n\n"
        "Или без кейса:\n"
        "/play1 — /play4 (1–4 игрока)\n\n"
        "Другие команды:\n"
        "/hand — карты на руке\n"
        "/status — счётчики\n"
        "/log — история ходов\n"
